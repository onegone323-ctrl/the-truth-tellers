...
export default function AlignmentTrendChart({ data }) {
  return (
    <div className="lux-card rounded-xl p-4 sm:p-5">
      <div className="text-sm uppercase tracking-widest text-gold-leaf/80 mb-1">Alignment Trend</div>
      ...
      <ResponsiveContainer width="100%" height={220}>
        <LineChart data={data} margin={{ top: 5, right: 10, left: -18, bottom: 0 }}>
          ...
          <XAxis dataKey="date" tick={{ fill: "#a8a29e", fontSize: 14 }} stroke="rgba(212,175,55,0.2)" />
          <YAxis domain={[0, 100]} tick={{ fill: "#a8a29e", fontSize: 14 }} stroke="rgba(212,175,55,0.2)" unit="%" />
          <Tooltip
